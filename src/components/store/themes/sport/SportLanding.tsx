...
export default function SportLanding({ landingPage, store }: Props) {
  ...
  const headingFont = isRTL ? "'Cairo', sans-serif" : `'${theme?.fonts?.heading ?? SPORT_TOKENS.heading}', sans-serif`
  const bodyFont = isRTL ? "'Cairo', sans-serif" : `'${theme?.fonts?.body ?? SPORT_TOKENS.body}', sans-serif`
  ...
  return (
    <div
      ...
      {/* Font loader */}
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Cairo:wght@400;700;900&family=Barlow:wght@400;500;600;700&family=Barlow+Condensed:wght@500;600;700;800;900&display=swap');`}</style>
