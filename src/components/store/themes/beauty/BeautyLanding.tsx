...
export default function BeautyLanding({ landingPage, store }: Props) {
  ...
  const headingFont = isRTL ? "'Cairo', sans-serif" : `'${theme?.fonts?.heading ?? BEAUTY_TOKENS.heading}', serif`
  const bodyFont = isRTL ? "'Cairo', sans-serif" : `'${theme?.fonts?.body ?? BEAUTY_TOKENS.body}', sans-serif`
  ...
  return (
    <div
      ...
      <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cairo:wght@400;700;900&family=Cormorant+Garamond:wght@400;500;600;700&family=Jost:wght@400;500;600;700&display=swap" />
