...
export default function TechLanding({ landingPage, store }: Props) {
  ...
  const headingFont = isRTL ? "'Cairo', sans-serif" : `'${theme?.fonts?.heading ?? TECH_TOKENS.heading}', sans-serif`
  const bodyFont = isRTL ? "'Cairo', sans-serif" : `'${theme?.fonts?.body ?? TECH_TOKENS.body}', sans-serif`
  ...
  return (
    <div
      ...
      <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cairo:wght@400;700;900&family=Poppins:wght@400;500;600;700;800&display=swap" />
