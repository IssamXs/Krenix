...
export default function CarLanding({ landingPage, store }: Props) {
  ...
  const headingFont = isRTL ? "'Cairo', sans-serif" : `'${theme?.fonts?.heading ?? CAR_TOKENS.heading}', sans-serif`
  const bodyFont = isRTL ? "'Cairo', sans-serif" : `'${theme?.fonts?.body ?? CAR_TOKENS.body}', sans-serif`
